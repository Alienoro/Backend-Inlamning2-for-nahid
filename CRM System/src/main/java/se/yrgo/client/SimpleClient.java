...
public class SimpleClient {
    ...
    public static void main(String[] args) {
        ...
        try (ClassPathXmlApplicationContext container = new ClassPathXmlApplicationContext("application.xml")) {
            ...
            // Del 1: tog bort bean för CustomerManagementMockImpl i application.xml

            // CustomerManagementService customerManagement =
            // container.getBean(CustomerManagementMockImpl.class);
            ...
            System.out.println("Here we have the actions:");
